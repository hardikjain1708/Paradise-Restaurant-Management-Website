			...
			<div class="col s12 m4">
				<div class="card">
			        ...
			        <div class="card-content center">
			          <a href="backends/add-to-cart.php?id=<?php echo $arr_all[$i+$j-2]['id']; ?>" style="background: #e69953;" class="btn waves-effect waves-block waves-light" href="">Add To Cart</a>
			        </div>
				    </div>
